...
import { SHIFT_TYPES, WEEKDAYS } from "../lib/constants.js";
import { getTextColor } from "../lib/utils.js";

export const PlanGrid = ({ employees, plan, summaryData, stats, currentDate }) => {
